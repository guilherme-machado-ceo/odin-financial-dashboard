...
const contextExplainerPt = `Este dashboard acompanha a transicao do sistema financeiro global de um modelo centrado no dolar americano (USD) para um sistema multipolar onde Moedas Locais (ML), ouro e infraestrutura propria (CIPS, NDB, Bond Connect) ganham protagonismo. BRICS = Brasil, Russia, India, China, Africa do Sul. LATAM = America Latina. Dados de 2015-2025.`;
...
const pt: T = {
  ...
  nav: {
    ...
    toggle: "PT / EN", timeRange: "Periodo", months12: "12M", years3: "3A", years5: "5A", years10: "10A",
    region: "Regiao", all: "Todos (BRICS + LATAM)", brics: "BRICS (Brasil, Russia, India, China, Africa do Sul)", latam: "LATAM (America Latina)",
  },
  hero: {
    headline: "G20 — VOLATILIDADE CAMBIAL: MOEDA LOCAL (ML) vs DOLAR AMERICANO (USD)",
    kpiMarket: "Mercado de LC Bonds (Titulos em Moeda Local)", kpiGrowth: "Crescimento em 10 Anos",
    kpiTrade: "Comercio BRICS em Moeda Local", kpiNDB: "NDB (Novo Banco de Desenvolvimento) — Desembolsos em ML",
    kpiTCX: "TCX (The Currency Exchange Fund) — Hedge Acumulado", kpiCurrencies: "Moedas Cobertas pelo TCX",
    live: "AO VIVO", ptaxLabel: "BRL/USD Ptax (Taxa de Cambio comercial do BCB)",
    dividaBruta: "Divida Bruta do Governo Federal (%% do PIB — Produto Interno Bruto)", inflectionTitle: "PONTOS DE VIRADA 2025-2026",
  },
  banner: {
    tag: "CONTEXTO GEOPOLITICO",
    headline: "Brasil emite primeiro Panda Bond soberano em CNY 6 bilhoes — Marco na saida do financiamento em USD (Dolar Americano)",
    summary: "Pela primeira vez, o Brasil levanta divida soberana em yuan chines (CNY) em vez de dolares (USD). Isso sinaliza uma mudanca estrutural: titulos de Moeda Local (ML) substituem instrumentos em dolar, enquanto nacoes BRICS constroem infraestrutura paralela (CIPS — sistema de pagamentos chines, NDB — Novo Banco de Desenvolvimento, Bond Connect — conexao entre B3 e bolsa de Xangai).",
    source: "Fonte", date: "Junho 2025",
  },
  news: {
    title: "INTELIGENCIA DE MERCADO: NOTICIAS FINANCEIRAS EM TEMPO REAL (RSS)",
    subtitle: "Feeds agregados de fontes globais — Sem chave de API necessaria (Google News RSS)",
    readMore: "Ler mais", source: "Fonte", error: "Feed temporariamente indisponivel. Usando dados de contingencia.",
  },
  climate: {
    title: "VETOR CLIMATICO: ANOMALIAS E RISCOS AMBIENTAIS BRICS+",
    subtitle: "Anomalias de temperatura e precipitacao (Open-Meteo — API sem chave) vs. medias historicas. Clima afeta commodities agricolas, energia e moedas.",
    avgTempAnomaly: "Anomalia Media de Temp.", avgPrecipAnomaly: "Anomalia de Precipitacao", highRiskCities: "Cidades em Alto Risco",
    riskScoreTitle: "Indice de Risco Climatico (0-100)", tempAnomalyTitle: "Anomalia de Temperatura (°C vs. media historica)",
  ...
  section1: {
    ...
    subtitle: "Ponto de virada 2025-2026 — Por que isso importa? O Brasil esta trocando o financiamento em dolar (USD) por yuan (CNY) e reais (BRL), reduzindo risco cambial e dependencia do sistema financeiro americano.",
    pandaBond: "Panda Bond Soberano (divida emitida na China em yuan)",
    cips: "CIPS (Cross-Border Interbank Payment System) — Sistema de pagamentos transfronteiricos da China",
    ndbTarget: "Meta LC do NDB (Novo Banco de Desenvolvimento) para 2026",
    swapLine: "Swap PBOC↔BCB (Banco Central da China ↔ Banco Central do Brasil) — Linha de cambio entre bancos centrais",
    bondConnect: "Bond Connect Bilateral (conexao entre B3 e bolsa de Xangai CFETS)",
    infographic: "FLUXO: Como funciona o financiamento Brasil-China em Moeda Local",
    flowStep1: "Emissao Panda Bond (B3 / CFETS — China Foreign Exchange Trade System)",
    flowStep2: "Liquidacao via CIPS (sistema chines, sem intermediario em USD)",
    flowStep3: "Conversao CNH (yuan offshore) ↔ BRL (real brasileiro)",
    flowStep4: "Investimento em Infraestrutura (sem exposicao ao dolar)",
    flowStep5: "Hedge via TCX (The Currency Exchange Fund) ou NDB",
    readAnalysis: "Leia a analise completa →", embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte Primaria", estBadge: "⚠️ est. (valor estimado)", ndbProgress: "Progresso rumo a meta de 30%% em Moeda Local (ML) — NDB 2026",
  },
  section2: {
    title: "TAMANHO DO MERCADO: BRICS + LATAM LC BONDS (TITULOS EM MOEDA LOCAL)",
    subtitle: "Evolucao 2015-2025 em US$ bilhoes — O que sao LC Bonds? Titulos de divida emitidos na moeda do proprio pais, nao em dolar. Isso protege contra variacoes cambiais.",
    seriesBrics: "BRICS (Brasil, Russia, India, China, Africa do Sul)", seriesLatam: "LATAM (America Latina)", seriesTotal: "Total",
  ...
  section3: {
    ...
    subtitle: "Desvio-padrao anualizado (%%) — O que e volatilidade? Quanto a moeda de um pais sobe e desce contra o dolar em um ano. Quanto maior, mais arriscado.",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte", estBadge: "⚠️ est. (estimado, nao oficial)", tableTitle: "Volatilidade Anualizada — Dados Oficiais vs. Estimados 2025",
    currency: "Moeda", official: "Oficial (Alpha Vantage — provedor de dados de mercado)", estimated: "2025e (estimativa)",
  },
  section4: {
    title: "TCX (THE CURRENCY EXCHANGE FUND): HEDGING (PROTECAO) DE MOEDA LOCAL",
    subtitle: "Portfolio outstanding (US$ bi) — O que e TCX? Um fundo que protege investidores contra risco de cambio em mercados emergentes. Cobre 71 moedas.",
    seriesHedged: "Hedge Anual (protecao contratada)", seriesOutstanding: "Portfolio Total (patrimonio sob gestao)", seriesCurrencies: "Numero de Moedas Cobertas",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte", estBadge: "⚠️ est. (estimado)",
  },
  section5: {
    title: "COMPOSICAO DA DIVIDA: MOEDA LOCAL (ML) vs MOEDA ESTRANGEIRA (ME)",
    subtitle: "Estrutura por pais (%% da divida total) — Por que ML e melhor? Divida em moeda propria nao sobe quando o dolar sobe. Divida em dolar (ME) fica mais cara se a moeda local cai.",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte", estBadge: "⚠️ est. (estimado)", debtToGdp: "Divida vs. PIB (Produto Interno Bruto)",
    official: "Dado Oficial", estimated: "2025e (estimativa)", vsEst: "vs est.",
  },
  spreads: {
    title: "DIFERENCIAIS DE TAXA (SPREAD) vs VOLATILIDADE CAMBIAL",
    subtitle: "Spread vs USD em basis points (bps — 1 bps = 0.01%%) e volatilidade FX anualizada (%%) — O que e spread? A diferenca de juros que um pais paga vs. os EUA. Quanto maior, mais caro e o dinheiro.",
    country: "Pais", spread2025e: "Spread 2025e (bps)", trend: "Tendencia do Spread", volatility: "Volatilidade FX (%%)",
    reducing: "Reduzindo (ficando mais barato)", stable: "Estavel", widening: "Ampliando (ficando mais caro)",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte", estBadge: "⚠️ est. (estimado)", fxLabel: "FX = Foreign Exchange (cambio internacional)",
  },
  stability: {
    title: "GANHO DE ESTABILIDADE ECONOMICA vs PARTICIPACAO DE DIVIDA EM MOEDA LOCAL",
    subtitle: "Score composto de estabilidade (0-100) vs. %% da divida em ML — Paises com mais divida em moeda propria tendem a ser mais estaveis economicamente.",
    xAxis: "Participacao de Divida em Moeda Local (ML) — 2025e", yAxis: "Score de Estabilidade Economica (0-100)",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte", estBadge: "⚠️ est. (estimado)",
  },
  gold: {
    title: "RESERVAS DE OURO: A ANCORA ANTI-DOLAR DOS BRICS+",
    subtitle: "Toneladas de ouro em reservas oficiais (2015-2025) — Por que ouro importa? Ouro e dinheiro real que nenhum pais pode imprimir. BRICS+ estao acumulando ouro para reduzir dependencia do dolar (USD).",
    ...
    seriesTurkey: "Turquia (CBRT — Banco Central da Turquia)", seriesPoland: "Polonia (NBP — Banco Central da Polonia)",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
    source: "Fonte: World Gold Council (WGC — Conselho Mundial do Ouro) / IMF COFER", estBadge: "⚠️ est. (estimado)",
  },
  goldShare: { title: "OURO COMO %% DAS RESERVAS TOTAIS (2025)", subtitle: "Quanto do cofre de cada pais esta em ouro vs. dolares, euros, etc. — Quanto maior o %% em ouro, menos dependencia do dolar.", country: "Pais", goldPct: "Ouro (%% das reservas)" },
  oil: {
    title: "VETOR PETROLEO: PRECO E PRODUCAO BRICS+",
    subtitle: "Brent (US$/barril) e producao BRICS+ (milhoes de barris/dia) — Petroleo e a commodity mais negociada do mundo. Se o preco sobe, moedas de exportadores (como o BRL) tendem a valorizar.",
    seriesBrent: "Brent (referencia internacional de petroleo)", seriesWTI: "WTI (West Texas Intermediate — referencia americana)",
    seriesProduction: "Producao BRICS+ (milhoes de barris/dia)", seriesPetroyuan: "Petroyuan (US$ bi negociados em yuan na Shanghai INE — Bolsa de Xangai)",
    embedLabel: "Incorporar", exportPNG: "Exportar PNG", exportPDF: "Exportar PDF", exportJSON: "Exportar JSON",
  ...
  sourceOverlay: { title: "Fonte Primaria", methodology: "Metodologia de Calculo", lastUpdated: "Atualizado em", close: "Fechar" },
  embedOverlay: { title: "Widget de Incorporacao (Embed)", description: "Copie o codigo abaixo para incorporar esta secao em seu site ou post:", copy: "Copiar", copied: "Copiado!", close: "Fechar" },
  footer: {
    compiledBy: "Compilado por", hubstry: "Hubstry Deep Tech", overall: "Overall 720°", snapshot: "snapshot Q2 2026",
    sources: "Fontes Primarias", disclaimer: "Valores aproximados. Verificar contra fontes primarias antes de publicar ou tomar decisao de investimento. Este dashboard e para fins educativos e de analise geopolitica, nao constitui recomendacao financeira.",
  },
  brazilSticky: {
    label: "BRASIL EM DESTAQUE", lcDebt: "Divida em Moeda Local (ML — %% do total)", fcDebt: "Divida em Moeda Estrangeira (ME — %% do total)",
    trend: "Tendencia 2015→2025", improving: "Melhorando", stable: "Estavel", concerning: "Preocupante",
  },
};
...
const en: T = {
  ...
  gold: {
    ...
    seriesTurkey: "Turkey (CBRT — Central Bank of the Republic of Turkey)", seriesPoland: "Poland (NBP — National Bank of Poland)",
    embedLabel: "Embed", exportPNG: "Export PNG", exportPDF: "Export PDF", exportJSON: "Export JSON",
